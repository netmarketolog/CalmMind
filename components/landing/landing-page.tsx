  ...
  return (
    <>
      <section
        ...
        className="scroll-mt-24 border-b border-border/60 bg-background pt-8 pb-10 sm:pt-10 sm:pb-12 lg:pt-12 lg:pb-14"
      >
        <Container>
      ...
      >
        <Container>
          <h2
            id="proof-heading"
            className="sr-only font-display text-2xl font-semibold tracking-tight text-foreground sm:not-sr-only sm:text-3xl"
          >
            {proof.title}
          </h2>
          <ul className="mt-0 grid gap-8 sm:mt-8 sm:grid-cols-3">
